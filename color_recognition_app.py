...
c1_header, c2_header, c3_header = st.columns([4, 0.5, 0.5])
with c1_header:		  
	st.markdown(
		"<h2 style='background-color: #AEC6CF; padding:0px; text-align: center; font-family: Courier, sans-serif;'>Color Recognition</h2>",
		unsafe_allow_html=True
	)
with c2_header:
	st.write('\n\n\n')
...
with c2:	
	st.markdown(
	f"<div style='font-family: Comic Sans MS, sans-serif; text-align: left;  height: 400px; padding: 20px;'>{text}</div>",
	unsafe_allow_html=True
    )
